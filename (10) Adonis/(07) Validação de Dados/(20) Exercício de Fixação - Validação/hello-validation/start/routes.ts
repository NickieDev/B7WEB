...
// Exercise
Route.post('/exercises/ex01', 'ExercisesController.Ex01')
Route.post('/exercises/ex02', 'ExercisesController.Ex02')
Route.post('/exercises/ex03', 'ExercisesController.Ex03')