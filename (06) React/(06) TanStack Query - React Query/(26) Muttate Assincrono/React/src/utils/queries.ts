...
export const invalidatePosts = () => {
   // Invalida a query que for informada
   queryClient.invalidateQueries({
      queryKey: ['posts'],  // Invalida todas as requisições de posts
      // exact: true // Assim so invalida somente o que for informado em queryKey
   })
}