// (08) Configuracoes para Qaulidade do Codigo
...
// noUnusedLocals = Avisa quando uma variavel é declarada mais nunca usada
// noUnusedParameters = Avisa quando um parametro nao e usado
// noImplicitReturns = Apenas quando houver retorno
