      ...
      <Dialog open={ open } onClose={ onClose } fullWidth>
         ...
         <DialogContent>
            <Box component='form' onSubmit={ handleFormSubmit } encType='multipart/form-data'>
               <Box sx={{ mb: 2 }}>
                  <InputLabel 
                     variant='standard' htmlFor=   'imgField'>
                     Imagem
                  </InputLabel>
               ...
               <Box sx={{ mb: 2 }}>
                  <InputLabel 
                     variant='standard' htmlFor=   'nameField'>
                     Nome
                  </InputLabel>
               ...
               <Box sx={{ mb: 2 }}>
                  <InputLabel 
                     variant='standard' htmlFor=   'priceField'>
                     Preço (em R$)
                  </InputLabel>
               ...
               <Box sx={{ mb: 2 }}>
                  <InputLabel 
                     variant='standard' htmlFor=   'descField'>
                     Descrição
                  </InputLabel>
               ...
               <Box sx={{ mb: 2 }}>
                  <InputLabel 
                     variant='standard' htmlFor=   'catField'>
                     Categoria
                  </InputLabel>
