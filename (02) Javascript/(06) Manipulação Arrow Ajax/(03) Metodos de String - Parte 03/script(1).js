...
//let resultado = nome.replace('Charllote', 'Yonkou') // Substitui o termo pelo outro

// let resultado = nome.toUpperCase()
// let resultado = nome.toLowerCase()

//let resultado = nome.concat(' Younkou')

//let resultado = nome.trim() // Remove espaços vazios no começo e no fim

//let resultado = nome.charAt(3) // Informa o caracter na posição
//let resultado = nome[2] // Apartir do ECMA5 é possivel acessar o caractere dessa forma

let resultado = nome.split(' ') // Corta a string com o parametro, tranformando os cortes em array
